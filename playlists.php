...
<body class="aero">
    <div class="playlist-player">
        ...
        <article>
            ...
            <div id="playlist-library">
                ...
                ?>
                <div id="playlist-library-cardspace" class="playlist-selection d-flex gap justify-content-center"></div>
                <div id="playlist-song-selection" class="playlist-selection d-flex gap justify-content-center">
                    <div class="position-relative">
                        <button class="btn btn-dark  position-absolute d-flex cursor-pointer">
                            <img style="height:2rem" class="hue-rotate" alt="&rarr;" src="/fancy-directory-index/assets/arrow-left.png">
                            <div class="my-auto">
                                Back
                            </div>
                        </button>
    ...
    <div id="playlist-data" data-json="<?= htmlspecialchars(json_encode($playlists, JSON_UNESCAPED_UNICODE), ENT_QUOTES, 'UTF-8') ?>"></div>
